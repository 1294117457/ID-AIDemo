...
/** 从 request body 中提取公共参数（文件解析、模板加载） */
...
/**
 * POST /agent/stream — 流式 SSE 入口
 *
 * 参数同 /agent/chat，响应为 SSE text/event-stream：
 *   data: {"type":"token","data":{"content":"..."}}
 *   data: {"type":"interrupt","data":{"question":"..."}}
 ...
 *
 * Body (application/json): { sessionId, supplement }
 */
...
/**
 * POST /agent/resume-stream — interrupt 恢复（流式 SSE）
 *
 * Body (application/json): { sessionId, supplement }
 */
