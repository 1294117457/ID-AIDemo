# 厦门大学保研加分智能助手 Agent 技术报告

> 课程：中间件技术 | 提交日期：2026-05-31
> 作者：zhouh
...
本项目为厦门大学信息学院保研加分智能助手，旨在为学生和教务管理人员提供一套基于大语言模型（LLM）的智能对话系统，帮助学生快速了解保研综合成绩加分政策、检索相关文件，以及辅助完成加分申请材料的提交。
...
*本报告基于项目源码 `src/` 目录（Commit: 2026-05-29）生成。*
