...
export function classifyPrompt(allUserText) {
...
export function consultSystemPrompt(systemRole, context) {
    return `${systemRole}\n\n【知识库检索结果】\n${context}`;
}
...
export function analyzeUserPrompt(documentText, templatesJson, policyContext) {
    return `学生上传了以下证明材料：
---
...
export function contextualAskPrompt(allUserText, missingFields) {
